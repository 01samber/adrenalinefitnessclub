...
export function PaymentsWorkspaceSkeleton() {
  return (
    <div
      ...
      role="status"
      aria-live="polite"
      aria-label="Loading payments workspace"
    >
      <p className="afc-section-label">Syncing payment ledger…</p>
      ...
      <div className="space-y-4 xl:hidden">
        {Array.from({ length: 3 }).map((_, index) => (
          <div key={index} className="afc-payment-card afc-payment-card--neutral p-5">
